...
import AdminContact from './Admin/Contect/AdminContact'
import AdminSingleContact from './Admin/Contect/AdminSingleContact'
    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='/admin-newsletter' element={localStorage.getItem("login") ? localStorage.getItem("role") === "Admin" ? <AdminNewsletter /> : <Profile /> : <Login />} />
          ...
          <Route path='/admin-users' element={localStorage.getItem("login") ? localStorage.getItem("role") === "Admin" ? <AdminUsers /> : <Profile /> : <Login />} />
        </Routes>
        <Footer />
      </BrowserRouter>
    </>

                                    ...
                                    </tr>
                                    {
                                        data.map((item,index)=>{
                                            return <tr key={index}>
                                                ...
                                                <td>{item.email}</td>
                                                <td>{item.phone}</td>
                                                <td>{item.subject.slice(0,30)+"..."}</td>
                                                <td>{item.status}</td>
                                                <td>{item.date}</td>
                                                <td><Link to={`/admin-single-contact/${item._id}`} className='btn text-primary'><i className='fa fa-eye'></i></Link></td>
                                                <td>
                                                    {
                                                        item.status==="Done"?
                                                        <button className='btn text-primary' onClick={()=>deleteItem(item._id)}><i className='fa fa-trash'></i></button>:""
                                                    }
                                                </td>
                                            </tr>
                                        })
